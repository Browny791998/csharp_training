                    ...
                    <ItemTemplate>
                        ...
                        <div class="col-md-10">
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                ...
                                <h3 class="col-md-5"><%# Eval("name") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Address: </h3>
                                <h3 class="col-md-5"><%# Eval("address") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Mobile: </h3>
                                <h3 class="col-md-5"><%# Eval("mobile") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Birth Date: </h3>
                                <h3 class="col-md-5"><%# Eval("dob") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Skill: </h3>
                                <h3 class="col-md-5"><%# Eval("skill") %></h3>
                            </div>

                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Experience: </h3>
                                <h3 class="col-md-5"><%# Eval("experience") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Degree Name: </h3>
                                <h3 class="col-md-5"><%# Eval("degree_name") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Email: </h3>
                                <h3 class="col-md-5"><%# Eval("email") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Detail: </h3>
                                <p class="col-md-5"><%# Eval("detail") %></p>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
