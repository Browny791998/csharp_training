...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mt-5 ml-5">
        ...
        <div class="col-md-2">
            Accept:
            <asp:RadioButton ID="rdoAccept" runat="server" GroupName="Accept" CssClass="custom-radio" AutoPostBack="True" OnCheckedChanged="rdoAccept_CheckedChanged" />
            Reject:
            <asp:RadioButton ID="rdoReject" runat="server" GroupName="Accept" CssClass="custom-radio" OnCheckedChanged="rdoReject_CheckedChanged" AutoPostBack="True" />
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-md-12">
