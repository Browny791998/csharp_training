<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Common/Layout/Main.Master" AutoEventWireup="true" CodeBehind="JobSeekerProfile.aspx.cs" EnableEventValidation="false" Inherits="Job_Portal_Management_System.Views.JobSeeker.JobSeekerProfile" ValidateRequest="false" %>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="col-md-10">
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                ...
                                <h3 class="col-md-4"><%# Eval("name") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Address: </h3>
                                <h3 class="col-md-4"><%# Eval("address") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Mobile: </h3>
                                <h3 class="col-md-4"><%# Eval("mobile") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Birth Date: </h3>
                                <h3 class="col-md-4"><%# Eval("dob") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Skill: </h3>
                                <h3 class="col-md-4"><%# Eval("skill") %></h3>
                            </div>

                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Experience: </h3>
                                <h3 class="col-md-4"><%# Eval("experience") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Degree Name: </h3>
                                <h3 class="col-md-4"><%# Eval("degree_name") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Email: </h3>
                                <h3 class="col-md-4"><%# Eval("email") %></h3>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
                                <h3 class="col-md-3">Detail: </h3>
                                <p class="col-md-4"><%# Eval("detail") %></p>
                            </div>
                            <div class="row d-flex flex-row justify-content-center mb-2">
