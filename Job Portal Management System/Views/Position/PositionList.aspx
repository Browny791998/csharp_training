<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Common/Layout/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="PositionList.aspx.cs" Inherits="Job_Portal_Management_System.Views.Position.Position" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="text-center text-warning" style="padding-bottom: 80px">Position List</h1>
    <div class="list-sec container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Search By Position" Style="padding: 5px 35px 5px 13px; outline: none;" CssClass="float-right mr-3" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
            </div>
        </div>
        <br />
        <div class="row">
                ...
                <asp:GridView ID="grvPosition" runat="server" CssClass="gvPosition table table-striped table-hover pt-5" AutoGenerateColumns="False" DataKeyNames="id" OnRowUpdating="grvPosition_RowUpdating" OnRowDeleting="grvPosition_RowDeleting" OnPageIndexChanging="grvPosition_PageIndexChanging" PageSize="5"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="20%">
                            <HeaderTemplate>
                                <asp:Label ID="Label3" runat="server" Text="Label">Position</asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <%#HttpUtility.HtmlEncode(Eval("position"))%>
                            </ItemTemplate>
