...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="text-center text-warning" style="padding-bottom: 80px">Specialization List</h1>
    <div class="list-sec container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Search By Specialization" Style="padding: 5px 35px 5px 13px; outline: none;" CssClass="float-right mr-3" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-md-12">
                <asp:GridView ID="grvSpecialization" runat="server" CssClass="gvSpecialization table table-striped table-hover pt-5" AutoGenerateColumns="False" DataKeyNames="id" OnRowUpdating="grvSpecialization_RowUpdating" OnRowDeleting="grvSpecialization_RowDeleting" OnPageIndexChanging="grvSpecialization_PageIndexChanging" PageSize="5"
