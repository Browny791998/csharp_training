    ...
    <div class="list-sec container card p-3 mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold mr-3" Text="Label">Company Name</asp:Label>
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:GridView ID="grvCompany" runat="server" CssClass="gvCompany table table-striped  pt-5" AutoGenerateColumns="False" DataKeyNames="id" PageSize="5"
