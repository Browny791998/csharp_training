    ...
    <div class="list-sec container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Search By Country Name" Style="padding: 5px 35px 5px 13px; outline: none;" CssClass="float-right mr-3" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
            </div>
        </div>
        <br />
        <div class="row">
