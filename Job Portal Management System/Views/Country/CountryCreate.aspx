<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Common/Layout/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="CountryCreate.aspx.cs" Inherits="Job_Portal_Management_System.Views.Country.CountryCreate" ValidateRequest="false" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" style="margin-top: 50px;">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="special charater doesn't allow" ForeColor="Red" ControlToValidate="txtCountry" ValidationExpression="^[0-9a-zA-Z\- \/_?:.,\s]+$" Display="Dynamic"></asp:RegularExpressionValidator>
