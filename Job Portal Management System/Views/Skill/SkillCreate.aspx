<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Common/Layout/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="SkillCreate.aspx.cs" Inherits="Job_Portal_Management_System.Views.Skill.SkillCreate" ValidateRequest="false" %>
        ...
        <div class="row">
            ...
            <div class="card col-md-11 ml-5 mt-5 p-3" style="height: 80vh;">
                <div class="card-body">
                  ...
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="special charater doesn't allow" ForeColor="Red" ControlToValidate="txtSkill" ValidationExpression="^[0-9a-zA-Z\-\#\+ \,/_?:.,\s]+$" Display="Dynamic"></asp:RegularExpressionValidator>
                        </div>
                    </div>
