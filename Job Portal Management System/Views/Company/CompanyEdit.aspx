<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Common/Layout/CompanyDashboard.Master" AutoEventWireup="true" CodeBehind="CompanyEdit.aspx.cs" Inherits="Job_Portal_Management_System.Views.Company.CompanyEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <%
         ...
         <h1 class="text-center text-info mt-3">Edit Company Information</h1>
        <div class="row">
